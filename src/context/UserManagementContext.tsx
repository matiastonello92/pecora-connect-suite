...
export const UserManagementProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  useEffect(() => {
    const mockUsers: UserProfile[] = [
      {
        ...
        language: 'it',
        permissions: ['inventory.read', 'inventory.write', 'staff.read'],
      ...
      {
        id: '2',
        email: 'sofia.bianchi@pecora.com',
        firstName: 'Sofia',
        lastName: 'Bianchi',
    ...
    dispatch({ type: 'LOAD_SHIFTS', payload: mockShifts });
    dispatch({ type: 'LOAD_TIME_ENTRIES', payload: mockTimeEntries });
  }, []);
